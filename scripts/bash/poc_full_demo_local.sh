#!/usr/bin/env bash
# ----------------------------------------------------------------------------
# Watsonx.ai ⚡ Matrix CLI — WOW Demo (process runner) [REFACTORED for LOCAL HUB]
#
# This script is a self-contained demo for a LOCAL Matrix Hub. It installs,
# starts, and interacts with a local WatsonX agent process.
# ----------------------------------------------------------------------------
set -Eeuo pipefail
...
ALIAS="${ALIAS:-watsonx-chat-local}"
...
# --- Banner ---
printf "\n${C_CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${C_RESET}\n"
printf   "${C_CYAN}  Watsonx.ai × Matrix Hub — Refactored Local Demo${C_RESET}\n"
