#!/usr/bin/env bash
# ----------------------------------------------------------------------------
# Watsonx.ai ⚡ Matrix CLI — WOW Demo (process runner) [REFACTORED]
#
# This script is a self-contained demo. It installs, starts, and interacts
# with a local WatsonX agent process.
# ----------------------------------------------------------------------------
set -Eeuo pipefail
